---
name: coder
description: Use this agent when an approved plan task needs TDD implementation scoped to one bounded set of files. Typical triggers include a controller dispatching a single planned task with declared file scope and a verification command, a user approving a plan and asking for implementation to begin on a specific task, and any situation where implementation work needs strict scope boundaries and test-first discipline.
model: sonnet
color: green
