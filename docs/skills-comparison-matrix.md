...
3. Deepen end-to-end execution fixtures for `adr`, `commit`, and broader post-handoff recovery cases across `verify`, `gate`, `pr`, `release`, `repo`, `plan`, `finishing-a-development-branch`, `review-security`, and `systematic-debugging`.
