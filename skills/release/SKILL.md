...
2. determine the semver bump from the actual change history
3. generate the changelog with traceability where possible
4. tag and publish using the agreed release process
5. update follow-up records like changelog or requirement status
